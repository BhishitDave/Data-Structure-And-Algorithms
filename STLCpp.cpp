...
void explainVector() {
	...
	vector<int>::iterator it = v.cbegin(); // yo cannot change the iterator
	it++;
	cout << *(it) << " "; // prints 20
	...
	vector<int>::iterator it = v.end(); // it will always point to after 40  not on 40

	vector<int>::iterator it = v.rend(); //it will always point to before 10  not on 10

	vector<int>::iterator it = v.rbegin(); // it will point to 40 



	cout << v[0] << " " << v.at(0); // same thing 

	cout << v.back() << " "; //point at 40


	// Ways to print the vector
    // can use normal for loop to iterate
	for (vector<int>::iterator it = v.begin(); it != v.end(); it++) {
		cout << *(it) << " ";
	}

    // auto is used to initialise it to iterator 
